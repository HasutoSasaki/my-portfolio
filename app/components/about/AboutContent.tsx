...
export const AboutContent = ({ isDarkMode, parentRef }: AboutContentProps) => {
  ...
  return (
    <div ref={contentRef} className="flex-1">
      <p>
        I am a software engineer at Classmethod, building web applications with React and TypeScript
        on the frontend and an AWS serverless stack (Lambda, DynamoDB, CDK) on the backend.
        <br />
        Before joining Classmethod, I spent two years as a frontend engineer at an SES company,
        where I handled projects end-to-end from planning and design to development, and also led
        engineering teams.
        <br />
